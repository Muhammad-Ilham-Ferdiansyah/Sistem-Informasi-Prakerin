    ...
    <div class="row">
      ...
      <div class="panel panel-flat">
        <div class="panel-heading">
          <h6 class="panel-title"><i class="icon-book3"></i> Data Siswa <a class="heading-elements-toggle"><i class="icon-more"></i></a></h6>
                  ...
                  <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a href="users/daftar_siswa/d/<?php echo $baris->nis; ?>" class="btn btn-info btn-xs"><i class="icon-eye"></i></a>
                          </td>
                        </tr>
                      <?php
                      $no++;
