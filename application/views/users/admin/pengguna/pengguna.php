          ...
          <div class="tabbable">
            <ul class="nav nav-tabs nav-tabs-highlight nav-justified">
              <li class="<?php if ($sub_menu3 == '') {
                            echo 'active';
                          } ?>"><a href="#tbl_pemb" data-toggle="tab" aria-expanded="true">+ Pembimbing</a></li>
              <li class="<?php if ($sub_menu3 == 'tbl_siswa') {
                            echo 'active';
                          } ?>"><a href="#tbl_siswa" data-toggle="tab" aria-expanded="true">+ Siswa</a></li>
            </ul>

            <div class="tab-content">
              <div class="tab-pane <?php if ($sub_menu3 == '') {
                                      echo 'active';
                                    } ?>" id="tbl_pemb">
                ...
                ?>
                <?php echo $this->session->flashdata('msg_sukses'); ?>
              ...
              <div class="tab-pane <?php if ($sub_menu3 == 'tbl_siswa') {
                                      echo 'active';
                                    } ?>" id="tbl_siswa">
                ...
                ?>
                <a href="users/pengguna/t_siswa" class="btn btn-primary"><i class="icon-user-plus"></i> Siswa Baru</a>
                <a href="users/pengguna/pembagian_pembimbing" class="btn btn-primary"><i class="icon-user-plus"></i> Pembagian Pembimbing</a>
