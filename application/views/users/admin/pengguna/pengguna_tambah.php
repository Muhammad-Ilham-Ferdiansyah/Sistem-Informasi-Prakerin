        ...
        <div class="panel panel-flat">
          ...
          <div class="panel-body">
            ...
            <fieldset class="content-group">
              <legend class="text-bold"><i class="icon-user-plus"></i> Tambah Pengguna <?php if ($sub_menu3 == 't_pemb') {
                                                                                          echo "Pembimbing";
                                                                                        } else {
                                                                                          echo "Siswa";
                                                                                        } ?></legend>
              ...
              if ($sub_menu3 == 't_pemb') { ?>
                <form class="form-horizontal" action="" method="post">
                  ...
                  <a href="javascript:history.back()" class="btn btn-default">
                    << Kembali</a> <button type="submit" name="btnsimpan" class="btn btn-primary" style="float:right;">
                        Simpan</button>
                </form>
              <?php
              } else { ?>
                <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <input type="text" name="nis" class="form-control" value="" placeholder="NIS" maxlength="11" required>
                    </div>
                  </div>
                  ...
                  <a href="javascript:history.back()" class="btn btn-default">
                    << Kembali</a> <button type="submit" name="btnsimpan2" class="btn btn-primary" style="float:right;">
                        Simpan</button>
                </form>
              <?php
              } ?>
