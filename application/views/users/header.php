...
<head>
	...
	<?php
		...
		<?php
	if ($sub_menu == "info" or $sub_menu == "j_k" or $sub_menu == "pengguna" or $sub_menu == "daftar_siswa" or $sub_menu == "industri" or $sub_menu == "penempatan" or $sub_menu == "nilai_praktik" or
...
<body>
	...
	<div class="navbar navbar-default header-highlight">
		<div class="navbar-header">
			<a class="navbar-brand" href=""style="color:white;"> PRAKERIN <span class="label bg-success-400">SMK</span></a>
				...
				<div class="sidebar-content">
					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							...
							<?php if ($level == 'Siswa'){?>
												<li class="<?php if ($sub_menu == "status_prakerin") { echo 'active';}?>"><a href="users/status_prakerin"><i class="icon-cogs"></i> <span>Status Prakerin</span></a></li>
							<?php } ?>
								...
								<?php if ($level == 'Admin'){ ?>
													...
													<li class="<?php if ($sub_menu == "daftar_siswa") { echo 'active';}?>"><a href="users/daftar_siswa"><i class="icon-book3"></i> <span>Daftar Siswa</span></a></li>
